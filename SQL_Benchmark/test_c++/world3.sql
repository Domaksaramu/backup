...
USE world_c;
SET AUTOCOMMIT = TRUE;
CREATE TABLE records(the_type CHAR(10) NOT NULL DEFAULT '',response_time INT(20) NOT NULL DEFAULT 0, error_flag INT NOT NULL DEFAULT 0, c_flag INT NOT NULL DEFAULT 1,the_date DATETIME NOT NULL DEFAULT NOW()) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8;
CREATE TABLE city(ID INT(11) NOT NULL AUTO_INCREMENT, Name CHAR(35) NOT NULL DEFAULT '', CountryCode CHAR(3) NOT NULL DEFAULT '', District CHAR(20) NOT NULL DEFAULT '', Population INT(11) NOT NULL DEFAULT '0', KEY ID (ID), KEY CountryCode (CountryCode)) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8;
...
CREATE TABLE countrylanguage (CountryCode CHAR(3) NOT NULL DEFAULT '', Language CHAR(30) NOT NULL DEFAULT '', IsOfficial enum('T','F') NOT NULL DEFAULT 'F', Percentage FLOAT(4,1) NOT NULL DEFAULT '0.0', KEY ContryCode_Language (CountryCode,Language), KEY CountryCode (CountryCode), CONSTRAINT countryLanguage_ibfk_1 FOREIGN KEY (CountryCode) REFERENCES country (Code)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
