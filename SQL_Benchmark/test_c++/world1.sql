...
CREATE TABLE records(
		the_type CHAR(10) NOT NULL DEFAULT '',
		response_time INT(20) NOT NULL DEFAULT 0, 
		error_flag INT NOT NULL DEFAULT 0, 
		c_flag INT NOT NULL DEFAULT 1,
...
CREATE TABLE city(ID INT(11) NOT NULL AUTO_INCREMENT, Name CHAR(35) NOT NULL DEFAULT '', CountryCode CHAR(3) NOT NULL DEFAULT '', District CHAR(20) NOT NULL DEFAULT '', Population INT(11) NOT NULL DEFAULT '0', PRIMARY KEY (ID), KEY CountryCode (CountryCode), CONSTRAINT `city_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`)) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8;
