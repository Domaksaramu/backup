...
USE world_p;
SET AUTOCOMMIT = TRUE;
CREATE TABLE records(the_type CHAR(10) NOT NULL DEFAULT '',response_time BIGINT(20) NOT NULL DEFAULT 0, error_flag INT NOT NULL DEFAULT 0, c_flag INT NOT NULL DEFAULT 1, the_date DATETIME NOT NULL DEFAULT NOW()) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8;
